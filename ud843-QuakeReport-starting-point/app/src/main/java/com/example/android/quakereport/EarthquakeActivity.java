...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EarthquakeAyncTask task = new EarthquakeAyncTask();
        task.execute(USGS_REQUEST_URL);
        task.execute(USGS_REQUEST_URL);
    }

    private class EarthquakeAyncTask extends AsyncTask<String, Void, List<Earthquake>>{
        ...
        protected List<Earthquake> doInBackground(String... urls) {
            ...
            //Perform HTTP request and receive response
        ...
        protected void onPostExecute(List<Earthquake> data){
            ...
            mAdapter.clear();
            //If there is valida list of {@link Earthquake}s, then add htme to thee data stet. This will trigger the ListView to update
