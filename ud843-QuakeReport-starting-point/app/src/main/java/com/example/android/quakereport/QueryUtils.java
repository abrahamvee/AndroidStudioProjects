...
public final class QueryUtils {
    ...
    **/
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestURL){
        ...
        List<Earthquake> earthquakes = extractEarthquakesFeatures(jsonResponse);
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakesFeatures(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                Earthquake earthquake = new Earthquake(property.getDouble("mag"), property.getString("place"), property.getLong("time"), property.getString("url"));
    ...
    /**
     * Returns a new URL object from a given String
     */
