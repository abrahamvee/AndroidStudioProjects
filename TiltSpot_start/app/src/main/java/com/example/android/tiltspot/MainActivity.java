...
public class MainActivity extends AppCompatActivity
    ...
    //Variables to hold copies of the acccelerometer and magnetometer
    private float[] mAccelerometer = new float[3];
    private float[] mMagnetometerData = new float[3];

    //for spot ImageView objects
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch(sensorType){
            case Sensor.TYPE_ACCELEROMETER:
                //clone method to explicityly make a copy of the data, prevents it being changed between calls
                mAccelerometer = sensorEvent.values.clone();
                break;
